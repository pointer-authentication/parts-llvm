...
%struct.extra_data2 = type { i32, %struct.extra_data1 }
%struct.extra_data1 = type { i32, %struct.data }
...
; CHECK:   store %struct.data* %1, %struct.data** getelementptr inbounds (%struct.extra_data4, %struct.extra_data4* @global_struct_data, i32 0, i32 1, i32 1, i32 1, i32 1, i32 0)
; CHECK:   ret void
; CHECK: }
