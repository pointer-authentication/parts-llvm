...
@global_array_data = global [4 x i8*] [i8* @global_data, i8* @global_data, i8* null, i8* @global_data], align 8
...
; CHECK-NOT:  call void @__pauth_pac_globals()
  ...
  %0 = load i8*, i8** getelementptr inbounds ([4 x i8*], [4 x i8*]* @global_array_data, i64 0, i64 0), align 8
