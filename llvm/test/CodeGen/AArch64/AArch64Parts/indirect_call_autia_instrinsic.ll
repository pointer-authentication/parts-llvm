...
entry:
  ...
  %1 = call void ()* @llvm.pa.autia.p0f_isVoidf(void ()* %0, i64 2887238391723867588)
  call void %1()
  ret void
}

; Function Attrs: nounwind readnone
declare void ()* @llvm.pa.autia.p0f_isVoidf(void ()*, i64) #2
...
; CHECK:	.globl	indcall                 // -- Begin function indcall
; CHECK:	.p2align	2
; CHECK:	.type	indcall,@function
...
; CHECK:	ret
; CHECK:.Lfunc_end0:
; CHECK:	.size	indcall, .Lfunc_end0-indcall
; CHECK:                                        // -- End function
; CHECK:	.type	indfunc,@object         // @indfunc
; CHECK:	.data
; CHECK:	.globl	indfunc
; CHECK:	.p2align	3
; CHECK:indfunc:
; CHECK:	.xword	extern_func
; CHECK:	.size	indfunc, 8
