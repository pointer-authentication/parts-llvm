...
; CHECK:   %9 = call i8* @llvm.pa.pacda.p0i8(i8* %8, i64 3284146682194183030)
...
; CHECK:   %11 = call i8* @llvm.pa.pacda.p0i8(i8* %10, i64 3284146682194183030)
...
; CHECK:   %13 = call i8* @llvm.pa.pacda.p0i8(i8* %12, i64 3284146682194183030)
...
; CHECK:   %15 = call i8* @llvm.pa.pacda.p0i8(i8* %14, i64 3284146682194183030)
...
; CHECK:   %17 = call i8* @llvm.pa.pacda.p0i8(i8* %16, i64 3284146682194183030)
...
; CHECK:   %19 = call i8* @llvm.pa.pacda.p0i8(i8* %18, i64 3284146682194183030)
...
; CHECK:   %21 = call i8* @llvm.pa.pacda.p0i8(i8* %20, i64 3284146682194183030)
...
; CHECK:   %23 = call i8* @llvm.pa.pacda.p0i8(i8* %22, i64 3284146682194183030)
